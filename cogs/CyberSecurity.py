...
class CyberSecurity(commands.Cog):
    ...
    @slash_command(guild_ids=guild_ids, name='scan', description='Retrieve virus scan report of the url', cooldown=commands.CooldownMapping.from_cooldown(2, 60, commands.BucketType.default), description_localizations={"zh-TW": "提取網址的病毒掃描報告"})
